                                ...
                                <div className="lg:w-1/2">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {(isFree || alreadyOwned) && (
                                            <button
                                                onClick={() =>
                                                    api.downloadInstructions(
                                                        parseInt(id),
                                                    )
                                                }
                                                className="w-full px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-medium rounded-xl transition-colors flex items-center justify-center gap-2"
                                            >
                                                <svg
                                                    className="w-5 h-5"
                                                    fill="none"
