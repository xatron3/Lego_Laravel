...
class FlipController extends Controller
{
  ...
  public function store(Request $request): JsonResponse
  {
    ...
    // Check free tier flip transaction limit
    if ($user->hasReachedFlipLimit()) {
      $limit = \App\Models\SiteSetting::getValue('free_flip_transaction_limit', 100);
      return response()->json([
        'message' => "You've reached the free limit of {$limit} flip transactions. Upgrade to Pro for unlimited flips!",
  ...
  public function stats(Request $request): JsonResponse
  {
    ...
    return response()->json([
      ...
      'limits' => [
        ...
        'remaining' => $request->user()->remainingFlipTransactions(),
        'limit' => $request->user()->isPro() ? null : (int) \App\Models\SiteSetting::getValue('free_flip_transaction_limit', 100),
      ],
      'status' => [
        'open_buys' => $openBuys,
